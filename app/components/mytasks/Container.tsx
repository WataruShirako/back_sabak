...
const Contaienr = () => {
  ...
  const [items, setItems] = useState<{
    ...
    container1: ['ユーザー認証実装', '閲覧履歴を実装', 'ロゴ修正依頼'],
    container2: ['DB設計書作成', '見積書の作成', 'supabase有料プラン加入'],
    container3: ['先方にワイヤー提出', '追加で1人アサイン', 'WBS作成'],
    container4: [],
  });
  ...
  return (
    <div className="flex flex-row mx-auto overflow-x-scroll">
      ...
      >
        {/* SortableContainer */}
        <SortableContainer id="container1" label="進行中" items={items.container1} />
        <SortableContainer id="container2" label="確認待ち" items={items.container2} />
        <SortableContainer id="container3" label="完了" items={items.container3} />
        <SortableContainer id="container4" label="container4" items={items.container4} />
        {/* DragOverlay */}
